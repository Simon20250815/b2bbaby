...
export const productsData: Product[] = [
  {
    ...
    title: 'Baby Stroller - Tested to ASTM F833-23',
    title_en: 'Baby Stroller - Tested to ASTM F833-23',
    category: 'stroller',
    description: 'High-performance travel stroller with one-hand fold in 2 seconds. Tested to ASTM F833-23 & EN 1888, 247+ export batches with zero return rate. Ideal for retailers targeting on-the-go families.',
    description_en: 'High-performance travel stroller with one-hand fold in 2 seconds. Tested to ASTM F833-23 & EN 1888, 247+ export batches with zero return rate. Ideal for retailers targeting on-the-go families.',
    moq: 50,
    leadTimeSample: '3-7 days',
    leadTimeProduction: '15-25 days',
    certifications: ['ASTM F833-23', 'CPC Documentation', 'EN 1888', 'ISO 9001'],
  ...
  {
    id: 2,
    slug: 'en-tested-safety-gate',
    title: 'Safety Gate - Tested to EN 1930',
    title_en: 'Safety Gate - Tested to EN 1930',
    category: 'safety_gate',
    description: 'Auto-close baby safety gate with double-locking system. Tested to EN 1930 & ASTM F1004, 189+ export batches. Extension kits available for wider openings up to 150cm. Perfect for baby-proofing specialists.',
    description_en: 'Auto-close baby safety gate with double-locking system. Tested to EN 1930 & ASTM F1004, 189+ export batches. Extension kits available for wider openings up to 150cm. Perfect for baby-proofing specialists.',
    moq: 100,
    leadTimeSample: '3-7 days',
    leadTimeProduction: '15-25 days',
  ...
  {
    id: 3,
    slug: 'high-chair-tested-astm-f404',
    title: 'High Chair - Tested to ASTM F404',
    title_en: 'High Chair - Tested to ASTM F404',
    category: 'high_chair',
    description: 'Food-grade high chair with FDA & LFGB compliant materials. 7-position height + 3-position recline, dishwasher-safe tray. 205+ export batches, 18-month warranty. Ideal for premium baby stores.',
    description_en: 'Food-grade high chair with FDA & LFGB compliant materials. 7-position height + 3-position recline, dishwasher-safe tray. 205+ export batches, 18-month warranty. Ideal for premium baby stores.',
    moq: 80,
    leadTimeSample: '3-7 days',
    leadTimeProduction: '15-25 days',
    ...
    features: [
      ...
      'CPC/ASTM F404 tested',
      'JPMA tested available'
    ],
    ...
    faq: [
      { q: 'Is the tray material food-safe?', a: 'Yes! All food-contact materials meet FDA and LFGB requirements. Tray is dishwasher-safe and BPA-free.' },
  ...
  },
  {
    ...
    category: 'bed-rail',
    description: 'Heightening bed rail with breathable mesh window for visibility. Adjustable length 120-200cm, fits 20-60cm mattresses. Tested to EN 1930 & ASTM F1004, 156+ export batches. Great for online marketplaces.',
    description_en: 'Heightening bed rail with breathable mesh window for visibility. Adjustable length 120-200cm, fits 20-60cm mattresses. Tested to EN 1930 & ASTM F1004, 156+ export batches. Great for online marketplaces.',
    moq: 60,
    leadTimeSample: '3-7 days',
    leadTimeProduction: '15-25 days',
